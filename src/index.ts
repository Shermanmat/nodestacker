...
// Legacy case studies (Seedscout era) redirect to the index
app.get('/case-studies/rosotics', (c) => c.redirect('/case-studies', 301));
app.get('/case-studies/autio', (c) => c.redirect('/case-studies', 301));
app.get('/case-studies/peachpay', (c) => c.redirect('/case-studies', 301));
app.get('/case-studies/insured-nomads', (c) => c.redirect('/case-studies', 301));
app.get('/case-studies/breathe-ev', (c) => c.redirect('/case-studies', 301));
app.get('/case-studies/othersideai', (c) => c.redirect('/case-studies', 301));
app.get('/case-studies/kalendar-ai', (c) => c.redirect('/case-studies', 301));
